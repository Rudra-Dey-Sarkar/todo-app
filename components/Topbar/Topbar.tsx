...
function ControlDarkMode(isDarkMode: boolean, setIsDarkMode: any) {
  if (isDarkMode === true) {
    setIsDarkMode(false);
  } else {
    setIsDarkMode(true);
    ...
    <div className='flex justify-between items-center px-2 py-2'>
      ...
      <div className='flex items-center gap-x-2'>
        <div
          ...
          <div className={`w-7 h-[3px] ${isDarkMode===true?"bg-white":"bg-black"} rounded-full ${sidebar === false ? "duration-300 ease-in-out transform translate-y-[0px] rotate-[0deg]" : "duration-300 ease-in-out transform translate-y-[9px] rotate-[-45deg]  "}`}></div>
          <div className={`w-7 h-[3px] ${isDarkMode===true?"bg-white":"bg-black"} rounded-full ${sidebar === false ? "opacity-100" : "opacity-0"}`}></div>
          <div className={`w-7 h-[3px] ${isDarkMode===true?"bg-white":"bg-black"} rounded-full ${sidebar === false ? "duration-300 ease-in-out transform translate-y-[0px] rotate-[0deg]" : "duration-300 ease-in-out transform translate-y-[-5px] rotate-[45deg]  "}`}></div>
        </div>
      ...
      <div className='flex gap-x-5 text-green-500'>
        ...
        <button onClick={()=>ControlDarkMode(isDarkMode, setIsDarkMode)}>
          <svg
            width={22}
            height={22}
            viewBox="0 0 22 22"
